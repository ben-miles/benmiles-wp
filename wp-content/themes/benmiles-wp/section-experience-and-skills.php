                    ...
                    <ul class="timeline">
                        ...
                        <li class="timeline-item timeline-inverted animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="https://shire-digital.com/" target="_blank">Shire Digital Solutions</a></li>
									<li><?php displaySVG('calendar'); ?>May 2018 - Present</li>
									<li><?php displaySVG('map-pin'); ?>Cocoa Beach, FL</li>
								</ul>
                            </div>
                        </li>
						...
						<li class="timeline-item animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://pipbrevard.com/" target="_blank">PIP Printing & Marketing</a></li>
									<li><?php displaySVG('calendar'); ?>Nov. 2017 - May 2018</li>
									<li><?php displaySVG('map-pin'); ?>Merritt Island, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-inverted animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://furrylogic.net/" target="_blank">furryLogic</a></li>
									<li><?php displaySVG('calendar'); ?>Nov. 2015 - Nov. 2017</li>
									<li><?php displaySVG('map-pin'); ?>Cocoa Village, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://pipbrevard.com/" target="_blank">PIP Printing & Marketing</a></li>
									<li><?php displaySVG('calendar'); ?>Feb. 2012 - Nov. 2015</li>
									<li><?php displaySVG('map-pin'); ?>Merritt Island, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-inverted animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://spacecoast.coupons/" target="_blank">Space Coast Coupons</a></li>
									<li><?php displaySVG('calendar'); ?>Nov. 2011 - Feb. 2012</li>
									<li><?php displaySVG('map-pin'); ?>Merritt Island, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://bcgm3.com/" target="_blank">BCGM3 Studios</a></li>
									<li><?php displaySVG('calendar'); ?>Apr. 2010 - Feb. 2012</li>
									<li><?php displaySVG('map-pin'); ?>Merritt Island, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-inverted animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://svad.cah.ucf.edu/" target="_blank">University of Central Florida</a></li>
									<li><?php displaySVG('calendar'); ?>2006 - 2009</li>
									<li><?php displaySVG('map-pin'); ?>Orlando, FL</li>
								</ul>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item animated" data-animation="fadeInUp">
                            ...
                            <div class="timeline-panel">
								...
								<ul class="timeline-details">
									<li><?php displaySVG('external-link'); ?><a href="http://easternflorida.edu/" target="_blank">Eastern Florida State College</a></li>
									<li><?php displaySVG('calendar'); ?>2004 - 2006</li>
									<li><?php displaySVG('map-pin'); ?>Cocoa, FL</li>
								</ul>
                            </div>
                        </li>
